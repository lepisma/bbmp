...
** UPCOMING BBMP #5
SCHEDULED: <2025-07-06 Sun 14:00-16:00>
:PROPERTIES:
:LOCATION: Dialogues Cafe, Koramangala
:ID:       6a68ff36-a38b-4918-bc7c-eb5cec3f0214
:END:

Tentative agenda (we will pick a few of these based on people's availability and
time):

1. @Manas to cover alleged Fermat's proof of FLT for $n=3$
2. @Satvik to cover Johnson–Lindenstrauss lemma
3. @Abhinav to cover Eisenstein Series
